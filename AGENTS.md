...
- `index.html`, `home/index.html`, and the pages under `developer/` (palette, system, db-design, security-ops, host-runbook, photo-export, github-progress): Vite entry points; the Developer nav link lands on GitHub project progress
