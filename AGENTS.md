...
- `index.html`, `home/index.html`, and the pages under `developer/` (system, db-design, security-ops, host-runbook, github-progress): Vite entry points; the Developer nav link lands on GitHub project progress
